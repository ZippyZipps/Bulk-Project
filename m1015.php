...
<center><b style="font-size:20px"><i>Lenovo K10</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.lenovo.com/in/en/smartphones/smartphone-k-series/Lenovo-K10-Note/p/PPIPIK10905"><img id="adImg" src="/Project/Images/mobiles/1015.1.jpg" width="100px" height="200px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/mobiles/1015.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1015.2.jpg'
    }
  </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/mobiles/1015.1.jpg' width="25px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1015.2.jpg' width="25px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1015";
    $res=pg_query($db,$q);
