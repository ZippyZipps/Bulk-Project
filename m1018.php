...
<center><b style="font-size:20px"><i>One Plus 7T</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.oneplus.in/7t"><img id="adImg" src="/Project/Images/mobiles/1018.1.jpg" width="220px" height="210px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/mobiles/1018.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1018.2.jpg'
    }
    function changeImgLink3()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1018.3.jpg'
    }
    function changeImgLink4()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1018.4.jpg'
    }
   </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/mobiles/1018.1.jpg' width="45px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1018.2.jpg' width="45px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1018.3.jpg' width="45px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1018.4.jpg' width="45px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1018";
    $res=pg_query($db,$q);
