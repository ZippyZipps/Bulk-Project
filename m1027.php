...
<center><b style="font-size:20px"><i>Sony Xperia Z4</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://gadgets.ndtv.com/sony-xperia-z4-2579"><img id="adImg" src="/Project/Images/tabs/1027.1.jpg" width="270px" height="170px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/tabs/1027.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1027.2.jpg'
    }
  </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/tabs/1027.1.jpg' width="55px" height="40px"></img></td>
      <td><img src='/Project/Images/tabs/1027.2.jpg' width="55px" height="40px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1027";
    $res=pg_query($db,$q);
  ...
  <?php
    $query="select mnm,cost,link
        ...
        where m.mno=bpm.mno AND b.brno=bpm.brno AND p.pno=bpm.pno AND pnm='$prnm' AND cost<'9000'";
