...
<center><b style="font-size:20px"><i>Lenovo Tab4 8 Plus</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.lenovo.com/in/en/tablets/android-tablets/tab-4-series/Lenovo-TB-8704/p/ZZITZTATB18"><img id="adImg" src="/Project/Images/tabs/1022.1.jpg" width="270px" height="200px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/tabs/1022.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1022.2.jpg'
    }
  </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/tabs/1022.1.jpg' width="55px" height="50px"></img></td>
      <td><img src='/Project/Images/tabs/1022.2.jpg' width="55px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1022";
    $res=pg_query($db,$q);
