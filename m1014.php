...
<center><b style="font-size:20px"><i>Lenovo A6 Note</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.lenovo.com/in/en/smartphones/a-series/Lenovo-A6-Note/p/PPIPPIA6904"><img id="adImg" src="/Project/Images/mobiles/1014.1.jpg" width="130px" height="250px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/mobiles/1014.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1014.2.jpg'
    }
  </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/mobiles/1014.1.jpg' width="30px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1014.2.jpg' width="30px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1014";
    $res=pg_query($db,$q);
