...
<li class="current-item"><a href="/Project/Codes/Tablethome.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tablets</a>
...
<center><b style="font-size:20px"><i>Samsung Galaxy Tab S5e</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.amazon.in/Samsung-Galaxy-10-5-Wi-Fi-Silver/dp/B07SX4G7B2"><img id="adImg" src="/Project/Images/tabs/1026.1.jpg" width="270px" height="170px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/tabs/1026.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1026.2.jpg'
    }
  </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/tabs/1026.1.jpg' width="55px" height="40px"></img></td>
      <td><img src='/Project/Images/tabs/1026.2.jpg' width="55px" height="40px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1026";
    $res=pg_query($db,$q);
