...
<center><b style="font-size:20px"><i>Lenovo Ideapad S145</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.lenovo.com/in/en/laptops/ideapad/s-series/Lenovo-IdeaPad-S145-15IWL/p/88IPS101200"><img id="adImg" src="/Project/Images/laptops/1006.1.jpg" width="270px" height="200px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/laptops/1006.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/laptops/1006.2.jpg'
    }
    function changeImgLink3()
    {
      document.getElementById('adImg').src='/Project/Images/laptops/1006.3.jpg'
    }
   </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/laptops/1006.1.jpg' width="50px" height="50px"></img></td>
      <td><img src='/Project/Images/laptops/1006.2.jpg' width="50px" height="50px"></img></td>
      <td><img src='/Project/Images/laptops/1006.3.jpg' width="50px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1006";
    $res=pg_query($db,$q);
  ...
  <?php
    $query="select mnm,cost,link
        ...
        where m.mno=bpm.mno AND b.brno=bpm.brno AND p.pno=bpm.pno AND pnm='$prnm' AND brnm='$bnm' AND cost>'$cst'";
