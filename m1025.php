...
<center><b style="font-size:20px"><i>Samsung Galaxy Tab A 10.1</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.samsung.com/in/tablets/galaxy-tab-a-10-1-t510/SM-T510NZKDINU/"><img id="adImg" src="/Project/Images/tabs/1025.1.jpg" width="240px" height="200px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/tabs/1025.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1025.2.jpg'
    }
    function changeImgLink3()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1025.3.jpg'
    }
    </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/tabs/1025.1.jpg' width="45px" height="50px"></img></td>
      <td><img src='/Project/Images/tabs/1025.2.jpg' width="55px" height="50px"></img></td>
      <td><img src='/Project/Images/tabs/1025.3.jpg' width="45px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1025";
    $res=pg_query($db,$q);
