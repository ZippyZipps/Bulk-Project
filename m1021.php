...
<center><b style="font-size:20px"><i>Dell Venue 7 3741</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.devicespecifications.com/en/model/7b57357f"><img id="adImg" src="/Project/Images/tabs/1021.1.jpg" width="250px" height="240px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/tabs/1021.1.jpg'
     }
    </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/tabs/1021.1.jpg' width="35px" height="50px"></img></td>
      </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1021";
    $res=pg_query($db,$q);
