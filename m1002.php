...
<center><b style="font-size:20px"><i>Apple MacBook Pro</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.apple.com/in/macbook-pro/"><img id="adImg" src="/Project/Images/laptops/1002.1.jpg" width="270px" height="250px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/laptops/1002.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/laptops/1002.2.jpg'
    }
    function changeImgLink3()
    {
      document.getElementById('adImg').src='/Project/Images/laptops/1002.3.jpg'
    }
   </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/laptops/1002.1.jpg' width="50px" height="50px"></img></td>
      <td><img src='/Project/Images/laptops/1002.2.jpg' width="50px" height="50px"></img></td>
      <td><img src='/Project/Images/laptops/1002.3.jpg' width="50px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1002";
    $res=pg_query($db,$q);
  ...
  <?php
    $query="select mnm,cost,link
        ...
        where m.mno=bpm.mno AND b.brno=bpm.brno AND p.pno=bpm.pno AND brnm='$bnm' AND pnm='$prnm' AND cost<'$cst'";
