...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="f1">
         ...
         <table width="35%" border="0">
            ...
            <tr style="font-size:22px"> 
                <td><b>Start Date</b><small>(mm-dd-yyyy)</small></td>
                <td><input type="text" name="dt1"></td>
            </tr>
            <tr style="font-size:22px"> 
                <td><b>End Date</b><small>(mm-dd-yyyy)</small></td>
                <td><input type="text" name="dt2"></td></tr>
...
$dt2= $_POST['dt2'];
  if(isset($_POST['generate'])) 
   {    
        ...
        $result2=pg_query($link,"SELECT f1('$mnm','$dt1','$dt2')");
