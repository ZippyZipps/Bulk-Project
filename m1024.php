...
<center><b style="font-size:20px"><i>Samsung Galaxy Tab A 7.0</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.samsung.com/in/tablets/galaxy-tab-a-7-0-t285n/SM-T285NZKSINS/"><img id="adImg" src="/Project/Images/tabs/1024.1.jpg" width="170px" height="200px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/tabs/1024.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1024.2.jpg'
    }
    function changeImgLink3()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1024.3.jpg'
    }
    function changeImgLink4()
    {
      document.getElementById('adImg').src='/Project/Images/tabs/1024.4.jpg'
    }
  </script><br>
   ...
   <input type="radio" name="imgs" id="radio3" onclick="changeImgLink3()"/> 
   <input type="radio" name="imgs" id="radio4" onclick="changeImgLink4()"/> 
   </center>
   <br><br>
   <center>
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/tabs/1024.1.jpg' width="40px" height="50px"></img></td>
      <td><img src='/Project/Images/tabs/1024.2.jpg' width="40px" height="50px"></img></td>
      <td><img src='/Project/Images/tabs/1024.3.jpg' width="40px" height="50px"></img></td>
      <td><img src='/Project/Images/tabs/1024.4.jpg' width="40px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1024";
    $res=pg_query($db,$q);
  ...
  <?php
    $query="select mnm,cost,link
        ...
        where m.mno=bpm.mno AND b.brno=bpm.brno AND p.pno=bpm.pno AND pnm='$prnm' AND cost<'$cst'";
