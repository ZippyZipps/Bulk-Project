...
<center><b style="font-size:20px"><i>Samsung Galaxy S10e</i></b></center>
<br><br><br>
<div class="row2">
  <div class="column2" style="background-color:#ffffff;"> 
     <br>
     <center>
     <a id="linking" href="https://www.samsung.com/in/smartphones/galaxy-s10-sm-g970/SM-G970FZKDINS/"><img id="adImg" src="/Project/Images/mobiles/1013.1.jpg" width="110px" height="230px"></a></img><br></center><center>
     <script type="text/javascript">
     function changeImgLink1()
     {
       document.getElementById('adImg').src='/Project/Images/mobiles/1013.1.jpg'
     }
    function changeImgLink2()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1013.2.jpg'
    }
    function changeImgLink3()
    {
      document.getElementById('adImg').src='/Project/Images/mobiles/1013.3.jpg'
    }
   </script><br>
   ...
   <table border='1' cellspacing="5px">
    <tr>
      <td><img src='/Project/Images/mobiles/1013.1.jpg' width="30px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1013.2.jpg' width="30px" height="50px"></img></td>
      <td><img src='/Project/Images/mobiles/1013.3.jpg' width="20px" height="50px"></img></td>
    </tr>
  </table>
  <br>
  ...
  <?php
    ...
    $q="select brnm,pnm,mnm,cost,camera,scrsz,ram,rom,processor,mfgdt
        ...
        AND m.mno=bpm.mno AND m.mno=1013";
    $res=pg_query($db,$q);
